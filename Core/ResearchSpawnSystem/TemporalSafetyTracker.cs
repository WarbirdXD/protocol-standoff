...
public class TemporalSafetyTracker : MonoBehaviour
{
	...
	private class CombatEvent
	{
		...
		public float GetCurrentIntensity()
		{
			...
			return Mathf.Max( 0f, intensity - age * 0.125f );
		}
	}
	...
	public float CalculateSafetyScore( Vector3 position )
	{
		...
		safetyScore -= spawnKillRisk * spawnKillPenalty;
	...
	{
		float cutoffTime = Time.time - recentTimeWindow * 2f;
	...
	{
		if( !showSafetyZones || !enableSafety )
			return;
